...
string Job::getCompanyName() const
{
    return companyName;
}

string Job::getRole() const
{
    return role;
}
...
string Job::getDeadline() const
{
    return deadline;
}
void Job::setStatus(const string &newStatus)
{
    status = newStatus;
}

void Job::setInterviewRound(const string &round)
{
    interviewRound = round;
}

void Job::setNotes(const string &newNotes)
{
    notes = newNotes;
}

void Job::setLastUpdated(const string &date)
{
    lastUpdated = date;
}
